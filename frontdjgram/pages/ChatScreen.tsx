import { SafeAreaView, Text, View, TouchableOpacity, Image, FlatList, RefreshControl } from 'react-native';
import styles from '../src/styles';
import { useEffect, useState } from 'react';
import TokenStorage from '../src/services/api/JwtToken'
import { useGetUserByIdQuery, useGetUserChatsQuery, useGetUserQuery } from '../src/services/api/api';
